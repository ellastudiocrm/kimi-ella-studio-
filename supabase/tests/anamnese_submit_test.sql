...
-- Fixture defensiva: admin para receber notificações de staff
...
-- Profissional B de teste + horários
...
BEGIN
    ...
    WHERE empresa_id = '00000000-0000-0000-0000-000000000001'
      AND tipo = 'anamnese_requer_avaliacao';
